...
const FloatingShield = dynamic(() => import("./floating-shield").then((mod) => mod.FloatingShield), {
  ssr: false,
  loading: () => <div className="w-full h-[400px] lg:h-[600px] animate-pulse bg-primary/5 rounded-3xl" />,
});
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-text-primary-light dark:text-text-primary-dark mb-8 leading-[1.1]"
            >
              Shield your secrets,
              <br />
            ...
            <motion.p
              ...
              className="text-xl text-text-secondary-light dark:text-text-secondary-dark max-w-2xl mb-12 leading-relaxed"
            >
          ...
          <motion.div
            ...
            className="w-full flex justify-center lg:justify-end relative h-[400px] lg:h-[600px]"
          >
            <FloatingShield />
          </motion.div>
        </div>

        {/* Interactive Terminal Preview - Centered below */}
        <motion.div
